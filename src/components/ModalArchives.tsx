...
export type DriveNode = {
  ...
  type: "folder" | "file";
  starred?: boolean;
  // si quieres mostrar tamaño/fecha, agrégalo aquí
};
...
type ModalMoveDialogProps = {
  ...
  loadChildren: LoadChildren;    // <-- conéctalo a tu API
...
export const ModalMoveDialog: React.FC<ModalMoveDialogProps> = ({
  ...
  // carga inicial / cuando cambia el path
  ...
  const filtered = useMemo(() => {
    ...
    // suggested/all los puedes diferenciar según tu lógica; por defecto all
    return nodes;
  }, [nodes, tab]);
